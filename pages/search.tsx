...
export const ItemsList = ({
  ...
  const goToPreviousPage = () => router.push({ query: { page: page - 1, query } })
  const goToNextPage = () => router.push({ query: { page: page + 1, query } })
...
const ItemsSearch = (props: InferGetServerSidePropsType<typeof getServerSideProps>) => {
    ...
    <>
      ...
      <div>
        <p>
          ...
          <Link href={Routes.NewItemPage({ name: props.query })}>
            <a
              className={ct(
                "relative",
                "ml-3",
        ...
        <button onClick={() => setAllItems(true)}>All items</button>
...
ItemsSearch.getLayout = (page: any) => <Layout>{page}</Layout>
