        ...
        <EditButton
          ...
          onClick={async () => {
            ...
            if (!firstPropertyInPreviousGroup) {
              throw new Error("trying to move down, but last property in next group is undefined")
            }
            ...
            setItem((item) => ({
              ...item,
              properties: [
                ...item.properties.filter((property) => !propertiesInNewOrder.includes(property)),
                ...propertiesInNewOrder,
              ],
            }))

            const propertiesWithNewPositions = propertiesInNewOrder.map((prop, index) => ({
              ...prop,
              position: index,
            }))
