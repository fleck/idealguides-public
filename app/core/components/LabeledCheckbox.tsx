...
export const LabeledCheckbox = forwardRef<HTMLInputElement, LabeledTextFieldProps>(
  ({ name, id, label, fieldProps, outerProps, formId = `${name}-${id}`, ...props }, ref) => {
    const {
      input,
    ...
    return (
      <div {...outerProps} className={ct("relative", "flex", "items-start")}>
        ...
        <div className="ml-3 text-sm">
          <label htmlFor={formId} className="font-medium text-gray-700 capitalize">
            {name}
          </label>
